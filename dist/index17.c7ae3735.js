...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/index17.js":[function(require,module,exports) {
// fetch() 
// .then(()=>{},()=>{})
//        실행   error
...
fetch('http://jsonplaceholder.typicode123.com/posts/1').then(function (response) {
  return response.text();
}).then(function (result) {
  console.log('welcome');
  console.log(result);
}).catch(function () {
  console.log('error가 발생되었습니다');
}).finally(function () {
  console.log('작업이끝났습니다');
});
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/index17.js"], null)
//# sourceMappingURL=/index17.c7ae3735.js.map